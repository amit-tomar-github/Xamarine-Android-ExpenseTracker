...
{
    public class DebitFragment : Android.Support.V4.App.Fragment
    {
        clsGlobal clsGLB;
        ...
        {
            var FragmentView = inflater.Inflate(Resource.Layout.fragment_debit, container, false);
            try
            {
        ...
        private async void AddDebitAsync()
        {
            ...
            try
            {
                ...
                await Task.Run(() => creditDebitDb.AddDebit(creditDebitHistory));
